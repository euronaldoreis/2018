...
<html>
<head>
  <title>Editar Jogador - Liga Tarcio</title>
        ...
        <div class="page-content">
          <div class="container" style="margin-top: 70px;">
            <div style="margin-bottom: 20px;">
              <a href="<?php echo base_url('painel/jogadores'); ?>" class="waves-effect waves-light btn"><i class="material-icons left"></i>Voltar</a>
            </div>
            <div class="card-panel">
              ...
              <div class="row">
                <form class="col s12">
                  <div class="row">
                    <?php if(($jogador[0]->escudo)): ?>
                    <div class="input-field col s12 center">
                      <p>Jogador do time</p>
                      <img src="<?php echo base_url('assets/escudos/'); ?><?php echo $jogador[0]->escudo; ?>" style="width: 100px;">
                      <p><?php echo $jogador[0]->nome; ?></p>
                    </div>
                    <?php endif; ?>
                  </div>
                  <div class="row">
                    <div class="input-field col s12">
                      <input id="icon_prefix" type="text" name="nome" value="<?php echo $jogador[0]->jogador; ?>" class="validate">
