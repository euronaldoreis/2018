        ...
        <div class="page-content">
          <div class="container" style="margin-top: 70px;">
          	<div style="margin-bottom: 20px;">
          		...
          		<a href="<?php echo base_url('painel/cadastrar_time'); ?>" class="waves-effect waves-light btn red right"><i class="material-icons left">add</i>Novo time</a>
          	</div>
          	  <ul class="collection">
				    ...
				    <li class="collection-item avatar">
				      ...
				      <p>PTS: <?php echo $row->pts; ?> <br>
				         Jogadores: 
				      </p>
				      <a href="<?php echo base_url('painel/editar_time/'); ?><?php echo $row->idtimes; ?>" class="secondary-content btn-floating btn waves-effect waves-light red"><i class="material-icons">mode_edit</i></a>
				    </li>
				<?php endforeach; ?>
			  </ul>
          </div>
